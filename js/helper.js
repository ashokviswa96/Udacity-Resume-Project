...
var HTMLbioPic =
    '<img src="%data%" class="biopic">';
var HTMLwelcomeMsg =
    '<span class="welcome-message">%data%</span>';
...
var HTMLworkLocation =
    '<div class="location-text">%data%</div>';
...
var internationalizeButton =
    '<button>Internationalize</button>';
...
function initializeMap() {
    ...
    */
    function createMapMarker(placeData) {
        ...
        var lat = placeData.geometry.location
            .lat(); // latitude from the place service
        var lon = placeData.geometry.location
            .lng(); // longitude from the place service
        ...
        // about a location.
        var message =
            '<div class="info"><h3>Markers information</h3><hr><ol class="infolist"><li>Address:\t' +
            marker.title +
            '</li><li>Position:\t' +
            marker.position +
            '</li></ol></div>';
